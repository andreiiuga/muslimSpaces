...
import { ArrowLeft, Heart, MapPin, Phone, Share2 } from "lucide-react-native";
...
export default function PoiDetailScreen() {
  ...
  function openDirections() {
    if (!poi) return;
    Linking.openURL(`https://www.google.com/maps/search/?api=1&query=${poi.location.lat},${poi.location.lng}`);
  }
